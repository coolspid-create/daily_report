...
- 자동 발행: `AUTOMATION_TIMEZONE`, `AUTOMATION_WINDOW_HOURS`(기본 168시간), `AUTO_APPROVAL_ENABLED`, `AUTO_APPROVAL_POLICY_VERSION`, `PRESS_RETRY_DELAY_SECONDS`(기본 60초), `PUBLIC_WEB_URL`
