insert into public.sources(
  ...
  'kei-research','한국환경연구원','RENDERED_BOARD','https://www.kei.re.kr','https://www.kei.re.kr',
  'rendered_board','config/sources/kei-research.yaml','LINK_ONLY',720,1500,false,'DISABLED'
